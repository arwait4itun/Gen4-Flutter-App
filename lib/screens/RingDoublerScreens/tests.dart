        ...
        MaterialPageRoute(
          builder: (_){
            ...
            if(_testTypeChoice=="MOTOR" &&(_motorNameChoice=="DRAFTING" || _motorNameChoice=="WINDING") || _testTypeChoice=="LIFT"&&_liftMotorsChoice=="BOTH"){
              ...
              return RingDoublerStopDiagnoseDoubleUI(
              ...
              return RingDoublerStopDiagnoseSingleUI(
                connection: connection,
                testsStream: testsStream,
                isLift: _testTypeChoice=="LIFT",
              );
...
class RingDoublerStopDiagnoseSingleUI extends StatefulWidget {
  ...
  RingDoublerStopDiagnoseSingleUI({required this.connection, required this.testsStream, required this.isLift});

  @override
  _RingDoublerStopDiagnoseSingleUIState createState() => _RingDoublerStopDiagnoseSingleUIState();
}

class _RingDoublerStopDiagnoseSingleUIState extends State<RingDoublerStopDiagnoseSingleUI> {
...
class RingDoublerStopDiagnoseDoubleUI extends StatefulWidget {
  ...
  RingDoublerStopDiagnoseDoubleUI({required this.connection, required this.testsStream, required this.isLift, required this.leftTitle, required this.rightTitle});

  @override
  _RingDoublerStopDiagnoseDoubleUIState createState() => _RingDoublerStopDiagnoseDoubleUIState();
}

class _RingDoublerStopDiagnoseDoubleUIState extends State<RingDoublerStopDiagnoseDoubleUI> {
