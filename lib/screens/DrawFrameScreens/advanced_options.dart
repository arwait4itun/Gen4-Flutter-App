...
class DrawFrameAdvancedOptionsUI extends StatefulWidget {
  ...
  DrawFrameAdvancedOptionsUI({required this.connection, required this.stream});

  @override
  _DrawFrameAdvancedOptionsUIState createState() => _DrawFrameAdvancedOptionsUIState();
}

class _DrawFrameAdvancedOptionsUIState extends State<DrawFrameAdvancedOptionsUI> {
