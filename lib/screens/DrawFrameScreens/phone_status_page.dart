...
class DrawFramePhoneStatusPageUI extends StatefulWidget {
  ...
  DrawFramePhoneStatusPageUI({required this.connection,required this.statusStream});

  @override
  _DrawFramePhoneStatusPageUIState createState() => _DrawFramePhoneStatusPageUIState();
}

class _DrawFramePhoneStatusPageUIState extends State<DrawFramePhoneStatusPageUI> {
