...
class BlowCardPopUpUI extends StatefulWidget {
  const BlowCardPopUpUI({Key? key}) : super(key: key);

  @override
  _BlowCardPopUpUIState createState() => _BlowCardPopUpUIState();
}

class _BlowCardPopUpUIState extends State<BlowCardPopUpUI> {
