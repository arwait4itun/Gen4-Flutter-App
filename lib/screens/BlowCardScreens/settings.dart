...
class BlowCardSettingsPage extends StatefulWidget {

  BluetoothConnection connection;

  Stream<Uint8List> settingsStream;

  BlowCardSettingsPage({required this.connection, required this.settingsStream});

  @override
  _BlowCardSettingsPageState createState() => _BlowCardSettingsPageState();
}

class _BlowCardSettingsPageState extends State<BlowCardSettingsPage> {
